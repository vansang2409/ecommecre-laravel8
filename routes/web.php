...
use App\Http\Livewire\Admin\AdminAddCouponConponent;
...
Route::middleware(['auth:sanctum', 'verified','authadmin'])->group( function () {
    ...
    Route::get('/admin/coupons',AdminCouponsConponent::class)->name('admin.coupons');
    Route::get('/admin/coupon/add',AdminAddCouponConponent::class)->name('admin.addcoupon');
    Route::get('/admin/coupn/edit/{coupon_id}',AdminEditCouponConponent::class)->name('admin.editcoupon');
