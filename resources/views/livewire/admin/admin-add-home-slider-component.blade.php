       ...
       <div class="col-md-12">
           <div class="panel panel-default">
              ...
              <div class="panel-body">
                  ...
                  @endif
                     <form class="form form-horizontal" wire:submit.prevent="addSlider">
                         ...
                         <div class="form-group">
                             <label for="image" class="col-md-4 control-label">Image</label>
                              <div class="col-md-4">
                                  <input type="file" class="col-md-4 input-file" wire:model='image'/>
                              </div>
                              @if($image)
                                 <img src="{{$image->TemporaryUrl()}}"  width="150px" />
                              @endif
                         </div>
                         <div class="form-group">
