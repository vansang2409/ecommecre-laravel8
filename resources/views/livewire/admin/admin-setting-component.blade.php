               ...
               <div class="panel panel-default">
                   ...
                   <div class="panel-body">
                       ...
                       <form action="" class="form-horizontal" wire:submit.prevent="saveSetting">
                           ...
                           <div class="form-group">
                               <label for="" class="col-md-2 control-label">Phone2</label>
                               <div class="col-md-8">
                           ...
                           <div class="form-group">
                               <label for="" class="col-md-2 control-label">Map</label>
                               <div class="col-md-8">
                           ...
                           <div class="form-group">
                               <label for="" class="col-md-2 control-label">Twiter</label>
                               <div class="col-md-8">
                           ...
                           <div class="form-group">
                               <label for="" class="col-md-2 control-label">Pinterest</label>
                               <div class="col-md-8">
                           ...
                           <div class="form-group">
                               <label for="" class="col-md-2 control-label">Youtube</label>
                               <div class="col-md-8">
                           ...
                           <div class="form-group">
                               <label for="" class="col-md-2 control-label">Facebook</label>
                               <div class="col-md-8">
                           ...
                           <div class="form-group">
                               <label for="" class="col-md-2 control-label">Instagram</label>
                               <div class="col-md-8">
