                    ...
                    <div class="panel-heading">
                       <div class="row">
                           ...
                           <div class="col-md-6">
                               ...
                               <a href="#" wire:click.prevent="cancelOrder" class="btn btn-warning pull-right" style="margin-right: 20px;"> Cancel</a>
                               @endif
                            </div>
                       </div>
                    </div>
                        ...
                        <div class="wrap-iten-in-cart">
                            ...
                            <ul class="products-cart">
                                ...
                                <li class="pr-cart-item">
                                    ...
                                    <div class="quantity"><h5>{{$item->quantity}}</h5></div>
                                    <div class="price-field sub-total"><p class="price">${{$item->price*$item->quantity}}</p></div>
                                    @if($order->status == 'canceled' && $item->rstatus == false)
