			...
			<div class="row">
				...
				<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12 sitebar">
					...
					<div class="widget mercado-widget widget-product">
						...
						<div class="widget-content">
							<ul class="products">
                                @foreach($Popular_product as $Pproduct)
                                    <li class="product-item">
                                        <div class="product product-widget-style">
                                            <div class="thumbnnail">
                                                <a href="{{route('product.details',['slug'=>$Pproduct->slug])}}" title="{{$Pproduct->name}}">
                                                    <figure><img src="{{asset('assets/images/products')}}/{{$Pproduct->image}}" alt="{{$Pproduct->image}}"></figure>
                                                </a>
                                            </div>
				...
				<div class="single-advance-box col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="wrap-show-advance-info-box style-1 box-in-site">
						...
						<div class="wrap-products">
                            ...
                            @foreach($Relation_product as $Rproduct)
								<div class="product product-style-2 equal-elem ">
									<div class="product-thumnail">
										<a href="{{route('product.details',['slug'=>$Pproduct->slug])}}" title="{{$Rproduct->name}}">
											<figure><img src="{{asset('assets/images/products')}}/{{$Rproduct->image}}" width="214" height="214" alt="{{$Rproduct->name}}"></figure>
										</a>
									...
									<div class="product-info">
										<a href="{{route('product.details',['slug'=>$Rproduct->slug])}}" class="product-name"><span>{{$Rproduct->name}}</span></a>
										<div class="wrap-price"><span class="product-price">${{$Rproduct->regular_price}}</span></div>
									</div>
								</div>
                             @endforeach
                             {{-- 
