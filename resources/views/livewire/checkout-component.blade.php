     ...
     <form wire:submit.prevent="placeOrder" onsubmit="$('#proccessing').show();">
                ...
                <div class="wrap-address-billing">
                   <h3 class="box-title">Billing Address</h3>
                    ...
                    <p class="row-in-form fill-wife">
                        ...
                        --}}
                        <label class="checkbox-field">
                            <input name="different-add" id="different-add" value="1" type="checkbox" wire:model="shipping_to_different">
            ...
            <div class="col-md-12">
                <div class="wrap-address-billing">
                   <h3 class="box-title">Shipping Address</h3>
                    ...
                    <p class="row-in-form">
                        <label for="zip-code">Postcode / ZIP:</label>
                        <input type="text" name="zip-code" value="" placeholder="Your postal code" wire:model="s_zipcode">
        ...
        <div class="summary summary-checkout">
                ...
                <div class="summary-item payment-method">
                    ...
                    @if($errors->isEmpty())
                         <div id="proccessing" style="font-size:22px;margin-bottom:30px;padding-left:37px;color:green;display:none;">
